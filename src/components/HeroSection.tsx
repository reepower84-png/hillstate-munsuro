  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/20251231_003310.jpg')" }}
      >
        {/* 어두운 오버레이 */}
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          <span className="text-amber-400">힐스테이트</span>
          <br />
          문수로 센트럴
        </h1>
        ...
        <p className="text-gray-400 text-base md:text-lg mb-10 max-w-2xl mx-auto">
          현대건설이 선보이는 프리미엄 라이프스타일의 완성
        </p>

        {/* 핵심 정보 */}
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-10">
          <div className="text-center px-6 py-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            <p className="text-amber-400 text-2xl md:text-3xl font-bold">울산 남구</p>
            <p className="text-gray-300 text-sm">삼산동 프리미엄 입지</p>
          </div>
          <div className="text-center px-6 py-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            <p className="text-amber-400 text-2xl md:text-3xl font-bold">힐스테이트</p>
            <p className="text-gray-300 text-sm">현대건설 프리미엄 브랜드</p>
          </div>
          <div className="text-center px-6 py-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            <p className="text-amber-400 text-2xl md:text-3xl font-bold">센트럴</p>
            <p className="text-gray-300 text-sm">중심 생활권의 가치</p>
          </div>
        </div>
