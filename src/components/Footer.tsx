      ...
      <div className="bg-amber-500 py-6">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="font-bold">울산광역시 남구 삼산동 1377-75번지</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div>
              <div className="mb-4">
                <img
                  src="/images/logo_2-removebg-preview.png"
                  alt="힐스테이트 문수로 센트럴"
                  className="h-12 w-auto"
                />
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">
                현대건설이 울산에 선보이는 프리미엄 주거 브랜드 힐스테이트.
                삼산동의 중심에서 새로운 주거 가치를 경험하세요.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-white">울산광역시 남구 삼산동 1377-75번지</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-gray-500 text-sm text-center md:text-left">
                © {currentYear} 힐스테이트 문수로 센트럴. All rights reserved.
              </p>
