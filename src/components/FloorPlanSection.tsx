  ...
  const floorPlans = [
    {
      ...
      image: "/images/ht 1.jpg",
      features: [
        "주방창 ~ 거실간 맞통풍 구조",
        "현관+펜트리 통합 가능",
        "ㄷ자형 주방 다용도실과 이어져 동선편리",
        "넓은 드레스룸",
        "침실 2,3 통합가능"
      ]
    },
    {
      ...
      image: "/images/ht 2.jpg",
      features: [
        "주방창 ~ 거실간 맞통풍 구조",
        "현관+펜트리 통합 가능",
        "ㄷ자형 히든 주방 구조와 거실 수납공간",
        "넓은 드레스룸 + 환기창",
        "침실 2,3 통합가능"
      ]
    },
        ...
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              <div className="mb-6">
                <span className="inline-block px-4 py-1 bg-amber-100 text-amber-700 font-semibold rounded-full text-sm mb-4">
                  {floorPlans[selectedType].structure}
                </span>
                <h3 className="text-3xl font-bold text-gray-900 mb-2">
                  {floorPlans[selectedType].type}타입
                </h3>
                <p className="text-lg text-gray-600 mb-1">
                  {floorPlans[selectedType].size}
                </p>
                <p className="text-xl font-bold text-amber-600">
                  {floorPlans[selectedType].realSize}
                </p>
              </div>
